...
class ShamirSecretSharing:
    ...
    def commit_coefficients(self, coefficients: List[FieldElement], g: Union[FieldElement, S256Point]) -> Union[List[FieldElement], List[S256Point]]:
    ...
    def verify_share(self, share: Tuple[FieldElement, FieldElement], commitments: Union[List[FieldElement], List[S256Point]], g: FieldElement) -> bool:
